...
export const REGIONS: Record<string, RegionConfig> = {
	...
	oregon: {
		...
		aboutConversation: [
			...
			"<em>OPEN POLL (now) → LIVE CONVERSATIONS (May/June) → SOLUTIONS FORUM (Fall)</em>",
			"<h2>Step 1: This Poll</h2>",
			...
			"<h2>Step 2: Live Conversations (May/June)",
			...
			"<h2>Solutions Forum (Fall 2026)</h2>",
