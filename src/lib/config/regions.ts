...
export interface RegionConfig {
	...
	heroBlurb: string;
	/** Optional carousel pre-header for invitation flow */
	carouselPreHeader?: string;
	/** Optional carousel header for invitation flow */
	carouselHeader?: string;
	/** Optional carousel slides for invitation flow */
	slides?: string[];
...
export const REGIONS: Record<string, RegionConfig> = {
	...
	stage: {
		...
		hostUrl: 'https://cocap.us/',
		zipPrefixes: [''],
		heroHeader: 'AI and Our Future',
		heroBlurb: 'Share your thoughts with other Bloom staging project members.',
		...
		contextParagraphs: [
			'This is a staging environment for testing the Civic OS platform.',
			'Use this region to validate changes before deploying to production.'
		],
		hostsBlurb: 'This conversation is hosted by Bloom Stage Project.',
		partners: [{ name: 'Bloom Stage Project', url: 'https://cocap.us/' }],
		hostMessage: [
			`
		  <p>YOUR HOSTS:</p>
		  <ul class='list-disc list-inside'>
		...
		faq: DEFAULT_FAQ,
		endCtaJoinDescription: 'Staging conversations are taking place.',
		endCtaShareDescription: 'Anyone in staging is welcome to participate.',
		events: [
			{
				slug: 'stage-event-1',
				title: 'Staged event1 ',
