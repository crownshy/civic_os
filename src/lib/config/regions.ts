...
export const REGIONS: Record<string, RegionConfig> = {
	...
	utah: {
		...
		whatsNext: "<a href=\"/conversations?utm_source=openpoll\" class=\"font-bold underline\">Sign up↗</a> for live conversations about this topic, taking place both online and in-person across Salt Lake, Utah, and Cache counties. These conversations will be an opportunity to connect with your neighbors and develop shared values around AI's influence on the people we care about.",
	...
	oregon: {
		...
		events: [
			{
				slug: 'may-16-central-oregon',
				title: 'AI & Central Oregon',
				topic: 'COMMUNITY CONVERSATION',
			...
			{
				slug: 'may-19-central-oregon-online',
