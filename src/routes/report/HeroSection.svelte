...
.bubble-scene {
  ...
  .col-outer-l { padding-bottom: calc(var(--b-md) * 0.7); }
  .col-center  { padding-bottom: calc(var(--b-sm) * 0.5);  }
  .col-outer-r { padding-bottom: calc(var(--b-md) * 0.7); }
  ...
  .b-sm { width: var(--b-sm); height: var(--b-sm); }
  .b-md { width: var(--b-md); height: var(--b-md); }
  .b-lg { width: var(--b-lg); height: var(--b-lg); }
</style>