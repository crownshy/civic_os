	...
	<div class="flex h-full flex-col bg-gradient-primary">
		...
		<div class="shrink-0 px-8 pt-6">
			<div class="flex items-center justify-between">
				...
				<span class="flex items-center gap-2">
					<span class="h-3 w-3 rounded-full border border-white bg-primary"></span>
		...
		<div class="flex shrink-0 items-center gap-3.5 border-t border-background bg-secondary px-7 py-8">
			<button
				...
				class="flex h-14 flex-1 items-center justify-center rounded-full bg-primary font-mono text-lg font-medium text-primary-foreground shadow-[0px_4px_8.2px_0px_rgba(0,0,0,0.25)]"
			>
				CONTINUE
			</button>
			<a
