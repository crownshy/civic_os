		...
		>
			...
			{#if showExpander}
				<button
					...
					class="bg-muted/40 hover:bg-muted text-foreground/70 hover:text-foreground text-lg col-span-full flex cursor-pointer items-center justify-center gap-2 py-5 font-normal transition-colors"
				>
			...
			{#if lowQualityCount > 0 && (expanded || !showExpander)}
				<button
					...
					class="text-lg col-span-full flex cursor-pointer items-center justify-center gap-2 bg-yellow-400/5 py-5 text-yellow-600 transition-colors hover:bg-yellow-400/10"
				>
					{showLowQuality
