...
<Story
	name="Some off"
	args={{ toggles: { contribute: true, email: false, feedback: false, share: true } }}
/>

<!-- No onToggle: the switches render but cannot be operated. -->
<Story name="Read only" args={{ onToggle: undefined }} />
